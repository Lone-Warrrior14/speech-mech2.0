...
def test_fan_noise():
    ...
    mic = get_global_mic()
    recognizer.dynamic_energy_ratio = 2.5 # Requires peak to be 2.5x the ambient background noise
    print(f"Mic initialized. Current Energy threshold: {recognizer.energy_threshold}")
